                    ...
                    <div class="card card-secondary">
                        ...
                        <form method="POST" action="proses_pasien.php" id="register-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kelurahan" value="<?= $row['kelurahan'] ?>" id="kelurahan">
                                        <?php foreach ($kelurahans as $kelurahan) { ?>
                                            <option value="<?= $kelurahan['id']; ?>" <?= $kelurahan['id'] == $row['kelurahan_id'] ? 'selected' : ''; ?>><?= $kelurahan['nama']; ?></option>
                            ...
                            <div class="card-footer">
                                <input type="submit" class="edit-form btn btn-primary" name="proses" value="Edit">
