<x-layout>
    ...
    <x-slot name="page_content">
        <form class="forms-sample" action="{{ url('dashboard/kelurahan/store') }}" method="">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="kecamatan_nama" name="kecamatan_nama" placeholder="Masukkan Nama Kecamatan">
                </div>
            </div>
            <div class="form-group row">
