    ...
    <x-slot name="page_content">
        <form class="forms-sample" action="{{ url('dashboard/kelurahan/update', $kelurahan->id) }}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Kelurahan" value="{{ $kelurahan->nama }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="kecamatan_nama" class="col-sm-4 col-form-label">Nama Kecamatan</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="kecamatan_nama" name="kecamatan_nama" placeholder="Masukkan Nama Kecamatan" value="{{ $kelurahan->kecamatan_nama }}">
                </div>
            </div>
            <div class="form-group row">
